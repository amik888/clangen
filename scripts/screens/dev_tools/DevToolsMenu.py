...
#                 return
            elif event.ui_element == self.traits_button:
                print("traits_button pressed.")
                self.change_screen('edit_traits')
                return
            elif event.ui_element == self.patrols_button:
                print("patrols_button pressed.")
...
#             manager=MANAGER)
        ...
        self.traits_button = UIImageButton(scale(
            pygame.Rect((140, 620), (384, 70))),
            "",
            object_id="#trait_button",
            manager=MANAGER)
        self.patrols_button = UIImageButton(
            scale(pygame.Rect((140, 710), (384, 70))),
            "",
            object_id="#patrol_button",
            manager=MANAGER)
        self.tool_buttons.append(self.traits_button)
        self.tool_buttons.append(self.patrols_button)
...
#         self.refresh_checkboxes()
    ...
    def exit_screen(self):
        ...
        for button in self.tool_buttons:
            button.kill()
            del button
#         self.traits_button.kill()
#         del self.traits_button
#         self.patrols_button.kill()
#         del self.patrols_button
...
#         self.save_settings_button.hide()
        self.traits_button.hide()
        self.patrols_button.hide()

        self.text_objects["info_container"] = pygame_gui.elements.UIScrollingContainer(
            scale(pygame.Rect((200, 300), (1200, 1000))),
            manager=MANAGER
        )

        self.text_objects['info_text_box'] = pygame_gui.elements.UITextBox(
            self.info_text,
...
# 
        i += 1
        self.text_objects["info_container"].set_scrollable_area_dimensions(
